        ...
        <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
            <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                ...
                <ul class="pb-2 space-y-2">
                    ...
                    {{-- Overview --}}
                    <li>
                        <x-sidebar-link href="" :active="request()->is('dashboard')">
                            <x-sidebar-icon>
                    ...
                    <li>
                        ...
                        <x-sidebar-dropdown-list id="Peminjaman" :active="request()->is('admin/peminjaman*')">
                            ...
                            {{-- Ajukan Peminjaman --}}
                            <li>
                                <x-sidebar-dropdown-list-link href="{{ route('admin.ajukan_peminjaman') }}" :active="request()->is('admin/ajukan_peminjaman')">
                                    Ajukan Peminjaman
                                </x-sidebar-dropdown-list-link>
                            </li>
